...
class ExpensesThisMonthViewController: UITableViewController {
        ...
        if segue.identifier == "expensedetail" {
            if let destVC = segue.destination as? ExpenseDetailViewController {
                ...
                if  let cell    = sender as? UITableViewCell,
                    ...
                    let expense = _budgets[index.section].expenses[index.row]
    ...
    override func numberOfSections(in tableView: UITableView) -> Int {
        return _budgets.count
    }

    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return _budgets[section].expenses.count
    }
    
    override func tableView(_ tableView: UITableView, titleForHeaderInSection section: Int) -> String? {
        print(budgets[section].day)
        return dateFormatter.string(from: _budgets[section].day)
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let expense = _budgets[indexPath.section].expenses[indexPath.row]
